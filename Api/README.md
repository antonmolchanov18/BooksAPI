...
### Prerequisites
Before diving into the project, ensure that you have the following prerequisites [installed](https://www.python.org/downloads/release/python-3120/) on your system:
